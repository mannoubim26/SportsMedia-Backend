-- railway.sql
-- Combined schema + seed for deploying to Railway MySQL.
-- Unlike database/schema.sql, this file does NOT contain
-- CREATE DATABASE / USE statements, so it loads into whatever
-- database you are connected to (on Railway that is `railway`).
--
-- How to use on Railway:
--   1. Open the MySQL service -> "Query" (or "Console") tab.
...
-- Seed data: predefined sport categories.
